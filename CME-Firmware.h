/* Coal Mine Elevator Firmware
 *
 * Allows for interactive control of the coal mine elevator on the Eli Whitney Museum seasonal train display
 *
 * See the documentation folder for details.
 *
 * A state machine is used to keep track of progress in the motor movement routine,
 * using non-blocking code. Several features, including direction reversal delays, motor watchdog
 * functionality, and error code display, are automatically handled externally and are
 * therefore not required to be included in the main loop.
 *
 * "Forward" involves the elevator moving away from its home position.
 *
...
const long MOTOR_TRAVEL_TARGET = 100;  // TODO
const long MOTOR_MAX_MOVEMENT = 101;   // TODO
const long OVERSHOOT_BUFFER = 5;       // TODO
const long UNDERSHOOT_BUFFER = 5;      // TODO
const long MOTOR_NEAR = 10;            // TODO

// State delays
const unsigned int MOTOR_IDLE_DELAY = 3000;
